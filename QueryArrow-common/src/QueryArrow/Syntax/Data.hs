...
-- types
data CastType = TypeCons String | TypeApp CastType CastType | TypeVar String | TypeUniv String CastType deriving (Eq, Ord, Show, Read, Generic)
...
pattern NullType = TypeCons "null"
