...
hApplyCULV g a l = case l of
            ...
            HCons e l' -> if a == 0
                then Just (HLeft' (g e))
                else HRight' <$> hApplyCULV @c @f g (a-1) l'
...
hApplyACULV g a l = case l of
            ...
            HCons e l' -> if a == 0
                then Just <$> (HLeft' <$> (g e))
                else getCompose (HRight' <$> Compose (hApplyACULV @c @f g (a-1) l'))
...
hApplyCULV' h a l = case l of
            ...
            HCons' e l' -> if a == 0
                then Just (HLeft' (h e))
                else HRight' <$> hApplyCULV' @c @f @g h (a-1) l'
